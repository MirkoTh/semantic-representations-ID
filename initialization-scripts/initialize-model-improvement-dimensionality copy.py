...
embed_dim_list = [200]#[49]  # 15,2, 3, 4, 5, 6 , 10, 15, 50, 85, 25, 50
learning_rate_list = [0.0005]  # 0.0005
# [0.0000001]  # 0.0000001, , 0.008, 0.05, 0.1, 0.5, 0.9, 0.0005
l_lmbda = [0.0000001]
...
# ,"testcase", , "full", "first_half", "second_half", "first_half_v2", "second_half_v2"
l_data_subset = ["testcase"]#["full_evaluate_actual"]
